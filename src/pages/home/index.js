...
export default function Home({ navigation, route }) {
  const { idUsuario } = route.params || {}; //carrega mesmo sem infomações do parametros

  console.log("Cod Usuario:", idUsuario);
  ...
  useEffect(() => {
    const fetchUsuarioData = async () => {
      try {
        ...
        }); //add o link url do banco de dados do usuario
        setNomeUsuario(resposta.data.nome); //nome deve estar da mesma maneira na json da api
      } catch {
      ...
      <View style={styles.container}>
        <TouchableOpacity onPress={() => navigation.navigate("Usuario")}>
          <View style={styles.user}>
            <Image
              ...
              source={require("./assets/user3.svg")}
            />
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Notificacao")}>
          <View style={styles.notifica}>
            <Image
              style={styles.imgnotifica}
              source={require("./assets/sino.svg")}
            />
          </View>
        </TouchableOpacity>
        <View>
        ...
        <Text style={styles.destaque}>
          Destaques da <Text style={styles.coloredText}>Semana</Text>
        </Text>
        ...
        <View>
          ...
          <TouchableOpacity>
            <View style={styles.trufadinho3}>
              ...
              <Image
                style={styles.imgsorvete}
                source={require("./assets/sorvete.png")}
              />
            </View>
          </TouchableOpacity>
          <TouchableOpacity>
